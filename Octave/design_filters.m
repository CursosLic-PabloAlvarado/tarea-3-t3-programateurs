...
[b, a] = ellip(n, rp, rs, Wp_low, 'low');
SOS = tf2sos(b, a);
save('ellip_lowpass.mat', 'SOS');

% Filtro eliptico paso alto
[b, a] = ellip(n, rp, rs, Wp_high, 'high');
SOS = tf2sos(b, a);
...
[b, a] = cheby1(n, rp, Wp_low);
SOS = tf2sos(b, a);
save('cheby1_lowpass.mat', 'SOS');

% Filtro cheby1 paso alto
[b, a] = cheby1(n, rp, Wp_high, 'high');
SOS = tf2sos(b, a);
...
[b, a] = cheby2(n, rs, Wp_low);
SOS = tf2sos(b, a);
save('cheby2_lowpass.mat', 'SOS');

% Filtro cheby2 paso alto
[b, a] = cheby2(n, rs, Wp_high, 'high');
SOS = tf2sos(b, a);
